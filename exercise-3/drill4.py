...
print "\tFor 46.0 litres in 892 Kms"
...
print "Expected Result: x = ((46.0 * 100) / 892) = 5.156950673"

print "Python Result: x = ", ((46.0 * 100) / 892)

print "\nNow that we have litres as a float, we only have a very small difference, due to the difference in the number of decimals between my PC calculator and Python."

print "\nThis can be easily solved when we learn how to display only a fixed number of decimals and to round them."
